    ...
    <div className="container mx-auto max-w-6xl px-4 py-10">
      <div className="mb-8 max-w-3xl">
        ...
        <p className="mt-4 text-lg leading-relaxed text-editorial-muted">
          Use one core subject, one supporting topic, and one role lens at a
          time when you want a little more structure. The point is not to remove
          curiosity. The point is to give it temporary focus.
        </p>
      </div>
